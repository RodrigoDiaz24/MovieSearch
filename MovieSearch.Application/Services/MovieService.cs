...
namespace MovieSearch.Application.Services
{
    public class MovieService : IMovieService
    {
        ...
        public MovieService(IMovieApiClient apiClient)
        {
        ...
        public async Task<IEnumerable<MovieResponse>> GetAllAsync()
        {
            ...
            return result ?? new List<MovieResponse>();
        }

        public async Task<IEnumerable<MovieResponse>> GetNearAsync(MovieRequest request)
        {
